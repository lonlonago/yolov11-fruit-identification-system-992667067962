...
YOLOv11 Fruit Identification System Based on Deep Learning YOLOv11's Fruit Identification and Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 6 classes,
Name: ['Apple', 'Banana', 'Grape', 'Orange', 'Pineapple', 'Watermelon'],
Dataset quantity: training set 7108 images, validation set 914 images, test set 457 images.
